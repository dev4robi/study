...
RBTNode* RBT_SearchMinNode(RBTNode* Tree)
{
    ...
    else return RBT_SearchMinNode(Tree->Left);
}
...
static int RBT_Test_main()
{
    ...
    while (1)
    {
        ...
        fprintf(stdout, "(1) Create a node, (2) Remove a node, (3) Search a Node\n");
        fprintf(stdout, "(4) Display Tree,  (5) Quit\n");
        fgets(buffer, sizeof(buffer) - 1, stdin);
        sscanf(buffer, "%d", &cmd);

        if (cmd < 1 || cmd > 5)
        {
            fprintf(stdout, "Invaild command number.\n");
            continue;
        }
        else if (cmd == 4)
        {
        ...
        fprintf(stdout, "Enter parameter (1~200) : \n");
        fgets(buffer, sizeof(buffer) - 1, stdin);
        sscanf(buffer, "%d", &param);

        if (param < 1 || param > 200)
        {
            fprintf(stdout, "Invaild parameter. %d\n", param);
            continue;
        }
        ...
        switch (cmd)
        {
            ...
            case 2:
                ...
                if (Node == NULL)
                    fprintf(stdout, "Not found node to delete : %d\n", param);
                else
            ...
            case 3:
                ...
                if (Node == NULL)
                    fprintf(stdout, "Not found node : %d\n", param);
                else
                    fprintf(stdout, "Found Node : %d(Color:%s)\n", Node->Data, (Node->Color == RED) ? "RED" : "BLACK");
                break;
        }
