...
pthread_mutex_t getInfo = PTHREAD_MUTEX_INITIALIZER;
int countNo = 0;
...
IpInfoType* get_ipInfo(void)
{
    ...
    mutexRlt = pthread_mutex_lock(&getInfo); //////////////////////////////////////// mutex lock begin
    countNo++;
    sleep(3);
    ...
    mutexRlt = pthread_mutex_unlock(&getInfo); //////////////////////////////////////// mutex lock end
